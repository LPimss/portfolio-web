...
const Accueil = () => {
  ...
  <>
    <div className="flex flex-col items-center justify-center h-1/2 bg-gray-300">
      ...
      <div className="mb-2">Kélian Roulez</div>
        <div className="mx-52 my-20 text-center">
    ...
    <div className='flex mb-4 my-4 justify-center'>

      <div className='flex flex-col  w-1/2 items-center border-r-8 border-black'>
        <h2 className='text-xl my-8 font-semibold'>Infos</h2>
        <p className='text-2xl'>CV</p>
        <div>
          Le Lorem Ipsum est simplement Le Lorem Ipsum <br /> est simplement Le Lorem Ipsum est simplement
        </div>
      </div>
