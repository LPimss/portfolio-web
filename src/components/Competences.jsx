      ...
      <div className="flex flex-col items-center justify-center h-screen">
        <div className="flex flex-wrap justify-center gap-8 mx-10">
          ...
          <div className="border p-8 w-96 h-96 rounded-xl">
            ...
            <ul className='list-disc'>
            <li className='text-red-500'><Link to="">Collecter, suivre et orienter des demandes</Link></li>
            <li className='text-red-500'><Link to="">Traiter des demandes concernant les services réseau et système, applicatifs</Link></li>
            <li className='text-red-500'><Link to="">Traiter des demandes concernant les applications</Link></li>
            </ul>
          </div>
          <div className="border p-8 w-96 h-96 rounded-xl">
