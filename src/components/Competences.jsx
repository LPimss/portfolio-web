      ...
      <div className="flex flex-col items-center justify-center h-screen">
        <div className="flex flex-wrap justify-center gap-16 mx-10">
          ...
          <div className="border p-8 w-96 h-96 rounded-xl">
            ...
            <li className='text-red-500'><Link to="c1.2">Exploiter des référentiels, normes et standards adoptés par le prestataire informatique</Link></li>
            ...
            <li className='text-red-500'><Link to="c1.4">Vérifier les conditions de la continuité d’un service informatique</Link></li>
            <li className='text-green-500'><Link to="/c1.5">Gérer des sauvegardes</Link></li>
            <li className='text-red-500'><Link to="c1.6">Vérifier le respect des règles d’utilisation des ressources numériques</Link></li>
              </ul>
          </div>
          <div className="border p-8 w-96 h-96 rounded-xl">
            ...
            <ul className='list-disc'>
            <li className='text-red-500'><Link to="c2.1">Collecter, suivre et orienter des demandes</Link></li>
            <li className='text-red-500'><Link to="c2.2">Traiter des demandes concernant les services réseau et système, applicatifs</Link></li>
            <li className='text-red-500'><Link to="c2.3">Traiter des demandes concernant les applications</Link></li>
            </ul>
          </div>
          <div className="border p-8 w-96 h-96 rounded-xl">
            ...
            <li className='text-red-500'><Link to="c3.2">Référencer les services en ligne de l’organisation et mesurer leur visibilité</Link></li>
        ...
        <div className="flex flex-wrap justify-center gap-16 m-10">
          <div className="border p-8 w-96 h-96 rounded-xl">
            ...
            <ul className='list-disc'>
            <li className='text-red-500'><Link to="c4.1">Analyser les objectifs et les modalités d’organisation d’un projet</Link></li>
            <li className='text-green-500'><Link to="/c4.2">Planifier les activités</Link></li>
            <li className='text-red-500'><Link to="c!4.3">Évaluer les indicateurs de suivi d’un projet et analyser les écarts</Link></li></ul>
          </div>
          <div className="border p-8 w-96 h-96 rounded-xl">
            <h2 className="text-lg font-bold mb-2 text-center pb-4">Mettre à disposition des utilisateurs un service informatique</h2>
            <ul className='list-disc'>
            <li className='text-red-500'><Link to="/c5.1">Réaliser les tests d’intégration et d’acceptation d’un service</Link></li>
          ...
          <div className="border p-8 w-96 h-96 rounded-xl">
            ...
            <ul className='list-disc'>
            <li className='text-red-500'><Link to="/c6.1">Mettre en place son environnement d’apprentissage personnel</Link></li>
            <li className='text-red-500'><Link to="/c6.2">Mettre en œuvre des outils et stratégies de veille informationnelle</Link></li>
            <li className='text-red-500'><Link to="/c6.3">Gérer son identité professionnelle</Link></li>
            <li className='text-red-500'><Link to="/c6.4">Développer son projet professionnel</Link></li></ul>
          </div>
        </div>
      </div>
    </div>
